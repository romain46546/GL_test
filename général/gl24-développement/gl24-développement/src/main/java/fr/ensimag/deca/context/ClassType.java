...
public class ClassType extends Type {
    ...
    public boolean sameType(Type otherType) {
        return otherType != null && otherType.isClass()
                && getName().equals(((ClassType) otherType).getName());
    }
    ...
    public boolean isSubClassOf(ClassType potentialSuperClass) {
        ...
        ClassDefinition superDef = definition.getSuperClass();
        while (superDef != null) {
            if (superDef.getType().sameType(potentialSuperClass)) {
                return true;
            }
