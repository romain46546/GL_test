...
public class Identifier extends AbstractIdentifier {
    ...
    public Type verifyExpr(DecacCompiler compiler, EnvironmentExp localEnv,
        ...
        if (localEnv == null) {
            throw new ContextualError("identifieur non déclaré" + name, getLocation());
        }
    ...
    protected void codeGenExp(DecacCompiler compiler, int currentRegister) {
        compiler.addInstruction(new LOAD(getExpDefinition().getOperand(), Register.getR(currentRegister)));
    }
}
